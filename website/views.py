...
def logout():
    logout_user()
    return redirect(url_for('views.login'))  # Redirect to the login page after logging out
...
def message():
    ...
    for da in data2:
        data.append(da.to)
    data = list(dict.fromkeys(data))  # Use 'data' instead of 'da'
